...
public class CFGGenerationforBranchvsStatementvsBasispathCoverage implements ICFGGeneration {
	final static AkaLogger logger = AkaLogger.get(CFGGenerationforBranchvsStatementvsBasispathCoverage.class);
	/**
	...
	public static void main(String[] args) throws Exception {
		...
		CFGGenerationforBranchvsStatementvsBasispathCoverage cfgGen = new CFGGenerationforBranchvsStatementvsBasispathCoverage(clone);
