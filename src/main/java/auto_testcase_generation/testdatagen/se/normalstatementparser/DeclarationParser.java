...
import auto_testcase_generation.testdatagen.se.memory.CharacterSymbolicVariable;
import auto_testcase_generation.testdatagen.se.memory.EnumSymbolicVariable;
import auto_testcase_generation.testdatagen.se.memory.NumberSymbolicVariable;
import auto_testcase_generation.testdatagen.se.memory.OneDimensionCharacterSymbolicVariable;
import auto_testcase_generation.testdatagen.se.memory.OneDimensionNumberSymbolicVariable;
import auto_testcase_generation.testdatagen.se.memory.OneLevelCharacterSymbolicVariable;
import auto_testcase_generation.testdatagen.se.memory.OneLevelNumberSymbolicVariable;
import auto_testcase_generation.testdatagen.se.memory.StructSymbolicVariable;
import auto_testcase_generation.testdatagen.se.memory.SymbolicVariable;
import auto_testcase_generation.testdatagen.se.memory.UnionSymbolicVariable;
