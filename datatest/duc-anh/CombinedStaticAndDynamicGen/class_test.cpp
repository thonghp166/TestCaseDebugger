...
//int class_test0(int i,int* i1,int i2[],int i3[2],char c,char* c1,char c2[],char c3[10], SinhVien* s){
...
//SinhVien class_test4(SinhVien sv, int x){
//    if (sv.getAge() > 0){
//       int a = class_test3(g_sv) + x[0];
//    }
//    return sv;
//}
