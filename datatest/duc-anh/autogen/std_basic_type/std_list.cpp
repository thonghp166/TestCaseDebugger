...
int structureArgument(std::list<MyClass> v) {
    return v.size();
}
...
int MyClassTemplateArgument(std::list<Array<int> > v) {
    return v.size();
}
...
int oneLevelStructureArgument(std::list<MyClass*> v) {
    return v.size();
}


int twoLevelStructureArgument(std::list<MyClass**> v) {
    return v.size();
}
...
int oneLevelStructure(std::list<MyClass>* v) {
    return v[0].size();
}

int twoLevelStructure(std::list<MyClass>** v) {
    return v[0][0].size();
}

int oneDimStructure(std::list<MyClass> v[]) {
    return v[0].size();
}

int twoDimStructure(std::list<MyClass> v[][4]) {
    return v[0][0].size();
}
